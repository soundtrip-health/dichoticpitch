/**
 * Vendored fft.js (v4.0.4) — adapted for AudioWorkletGlobalScope.
 * Original: https://github.com/nicedoc/fft.js (MIT license)
 * Change: module.exports → globalThis.FFT for AudioWorklet compat.
 */
'use strict';
